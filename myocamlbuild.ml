(* OASIS_START *)
(* DO NOT EDIT (digest: d9560623d22208c8b93284e48d0f8efe) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_executable_rsdpfor_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"; A "-thread"])]);
          (["oasis_executable_rsdpfor_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"])]);
          (["oasis_executable_rsdpfor_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"; A "-thread"])]);
          (["oasis_executable_rsdpfor_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"])]);
          (["oasis_executable_rsdpfor_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-g"; A "-thread"])]);
          (["oasis_executable_rsdpfor_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"])])
       ];
     includes = []
  }
