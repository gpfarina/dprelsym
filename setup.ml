...
(* OASIS_START *)
(* DO NOT EDIT (digest: 12a9157fb1c3ec0a53473ca513c87d61) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = [];
          beta_features = [];
          name = "Relational Symbolic Execution for DP";
          license_file = None;
          copyrights = [];
          maintainers = [];
          authors = ["Me <XXXX@gmail.com>"];
          homepage = Some "http://www.";
          bugreports = None;
          synopsis = "...";
          description = Some [];
          tags = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-g"; "-thread"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-thread"])]
                   },
                   {exec_custom = false; exec_main_is = "rsdpfor.ml"})
            ];
     ...
     oasis_digest = Some "\001,\142\220;\168\162\234j\171\134\006\233{UW";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
